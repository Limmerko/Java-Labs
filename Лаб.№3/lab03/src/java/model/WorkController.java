...
public class WorkController implements Serializable {
    ...
    @PersistenceUnit(unitName = "lab03PU")
    private EntityManagerFactory emf = null;

    private Work current;
    private DataModel items = null;
    private WorkJpaController jpaController = null;
    ...
    private WorkJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new WorkJpaController(utx, emf);
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getWorkCount();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getJpaController().findWorkEntities(getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getWorkCount();
        ...
        if (selectedItemIndex >= 0) {
            current = getJpaController().findWorkEntities(1, selectedItemIndex).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(getJpaController().findWorkEntities(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(getJpaController().findWorkEntities(), true);
    }
